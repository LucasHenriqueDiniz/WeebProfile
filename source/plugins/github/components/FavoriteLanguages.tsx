...
const DefaultFavoriteLanguages = ({ repositoriesData, maxLanguages: maxLanguages }: { repositoriesData: RepositoriesData; maxLanguages: number }) => {
...
const TerminalFavoriteLanguages = ({ repositoriesData, maxLanguages: maxLanguages }: { repositoriesData: RepositoriesData; maxLanguages: number }) => {
  const { totalLanguages } = repositoriesData;
