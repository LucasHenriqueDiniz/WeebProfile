...
export function PluginError({ pluginName, error, style = "default", size = "half" }: PluginErrorProps) {
    ...
    return (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
          ...
          <span style={{ fontWeight: "bold", color: "#ff6b6b" }}>{pluginName.toUpperCase()} ERROR</span>
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: "5px", fontSize: "14px", fontWeight: "500" }}>{errorName}:</div>
      <div style={{ fontSize: "14px", color: "#742a2a", whiteSpace: "pre-wrap" }}>{errorMessage}</div>
    </div>
  )
}
