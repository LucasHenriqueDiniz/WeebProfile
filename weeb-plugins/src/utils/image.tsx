...
export function ImageComponent({
  ...
  if (isDataUri) {
    return <img src={url64} alt={alt} data-name={alt} className={className} width={width} height={height} />
  }
  ...
  const imageUrl = isNodeEnv && !dontUseUrl64 && !isHttpUrl && !isDataUri ? `data:image/jpeg;base64,${url64}` : url64

  return <img src={imageUrl} alt={alt} data-name={alt} className={className} width={width} height={height} />
}
