 ...
 * from weeb-plugins/src/styles/default/styles.css
 * 
...
/* Duolingo plugin specific styles */
/* Plugin section container */
#svg-main .duolingo-plugin-section {
  display: flex;
  flex-direction: column;
}

/* List item container with Duolingo green gradient background */
#svg-main .duolingo-list-item {
  display: flex;
  flex-direction: column;
  background: linear-gradient(135deg, rgba(88, 204, 2, 0.082) 0%, rgba(137, 226, 25, 0.082) 100%);
...
/* Level badge (center content in list items) */
#svg-main .duolingo-level-badge {
  display: inline-flex;
  align-items: center;
  ...
  font-size: 0.75rem;
  font-weight: 600;
  background-color: rgba(88, 204, 2, 0.125);
  color: #58CC02;
  border: 1px solid rgba(88, 204, 2, 0.25);
}

/* XP text (left content in list items) */
#svg-main .duolingo-xp-text {
  font-size: 0.75rem;
  font-weight: 700;
  color: #58CC02;
}

/* Streak card with dynamic gradients based on intensity */
...
/* Duolingo text colors */
#svg-main .duolingo-text-snow {
  color: #FFFFFF;
}

/* Duolingo background decorations */
