 ...
 * 
 * Last generation: 2026-01-05T13:52:38.724Z
 */

/**
 * Union type of all available plugin names
 */
export type PluginName = "16personalities" | "codeforces" | "codewars" | "duolingo" | "github" | "lastfm" | "lyfta" | "myanimelist" | "stackoverflow" | "steam"
...
export function isValidPluginName(name: string): name is PluginName {
  return name in ["16personalities","codeforces","codewars","duolingo","github","lastfm","lyfta","myanimelist","stackoverflow","steam"]
}
