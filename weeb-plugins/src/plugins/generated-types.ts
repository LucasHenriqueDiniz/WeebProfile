 ...
 * 
 * Last generation: 2026-07-24T01:17:19.863Z
 */

/**
 * Union type of all available plugin names
 */
export type PluginName = "16personalities" | "codeforces" | "codewars" | "duolingo" | "github" | "github_repo" | "lastfm" | "lyfta" | "myanimelist" | "stackoverflow" | "steam"
...
export type PluginSectionIds = {
  ...
  github_repo: "banner" | "stats" | "star_graph" | "languages" | "topics"
...
export function isValidPluginName(name: string): name is PluginName {
  return name in ["16personalities","codeforces","codewars","duolingo","github","github_repo","lastfm","lyfta","myanimelist","stackoverflow","steam"]
}
