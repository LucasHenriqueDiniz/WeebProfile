...
export function CurrentStreak({
  ...
  style = "default",
  size = "half",
}: CurrentStreakProps): React.ReactElement {
      ...
      <RenderBasedOnStyle
              ...
              <div className="relative z-10 flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-baseline gap-2 mb-1">
                    ...
                    <span className="text-sm font-semibold opacity-90 duolingo-text-snow">days</span>
                  </div>
                  <p className="text-sm font-semibold opacity-95 duolingo-text-snow">{message}</p>
                </div>
                ...
                <div className="flex-shrink-0">
                  <FaFire
                    ...
                    style={{
                      filter:
                        intensity === "godlike" || intensity === "legendary"
        ...
        terminalComponent={
          <>
            ...
            />
            <TerminalLineWithDots title="Current Streak" value={`${abbreviateNumber(streak)} days`} />
          </>
        }
      />
    </section>
