...
export async function getMockGithubData(): Promise<GithubData> {
    ...
    starredRepositories: {
      ...
      nodes: [
        ...
        },
        {
          ...
          description:
            "🦌 One-command Terraform stack that deploys single-node ELK + Fleet/APM on AWS, fronted by an ALB with custom domain and HTTPS",
  ...
  return {
    ...
    sponsorships: realData.sponsorships
      ...
      : undefined,
    repositoryContributors:
      repositoryContributors.length > 0 ? repositoryContributors : realData.repositoryContributors,
  }
}
