...
├── components/
│   └── Render16personalities.tsx  # Componente de renderização
...
2. Substitua todos os placeholders:
   - `16personalities` → nome do plugin (ex: "spotify")
   - `16personalities` → PascalCase (ex: "Spotify")
   - `16personalities_UPPER` → UPPER_CASE (ex: "SPOTIFY")
...
- `16personalities` - Nome do plugin em kebab-case (ex: "spotify")
- `16personalities` - Nome do plugin em PascalCase (ex: "Spotify")
- `16personalities_UPPER` - Nome do plugin em UPPER_CASE (ex: "SPOTIFY")
