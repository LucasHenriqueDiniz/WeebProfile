...
// No generation timestamp in the output. The file is committed, so every build
// rewrote it with a new date and produced a diff with no change in meaning --
// three of thirty commits at one point were just that, and it conflicted on every
// branch. git already knows when the file last changed.
