...
export const TemplateCardSkeleton = memo(function TemplateCardSkeleton({ index = 0 }: TemplateCardSkeletonProps) {
  return (
    <motion.div
...
export const SvgCardSkeleton = memo(function SvgCardSkeleton({ index = 0 }: SvgCardSkeletonProps) {
  return (
    <motion.div
