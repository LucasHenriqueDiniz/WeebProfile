...
export const HeroTemplateCard = memo(function HeroTemplateCard({ template, isActive, onClick }: HeroTemplateCardProps) {
            ...
            <div className="p-3.5">
              ...
              <div className="flex items-center gap-2.5 mb-2.5">
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-bold text-foreground truncate">{template.name}</div>
                </div>
              ...
              <div className="flex items-center gap-1" aria-label={`Plugins: ${template.plugins.join(", ")}`}>
                ...
                {template.plugins.length > 3 && (
                  <div className="w-5 h-5 rounded bg-muted/50 border border-border/50 flex items-center justify-center">
                    <span className="text-[9px] text-muted-foreground font-medium">+{template.plugins.length - 3}</span>
                  </div>
                )}
              </div>
            </div>
