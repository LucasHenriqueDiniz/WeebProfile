    ...
    return (
      <div
        className={cn(
          ...
          state.enabled ? "border-primary/30 shadow-sm shadow-primary/5" : "border-border hover:border-primary/20",
          hasMissingRequired &&
            state.enabled &&
      ...
      >
        <div className="p-4">
          ...
          <div onClick={handleToggleExpanded} className="flex items-center gap-3 cursor-pointer group">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Badge
                                variant="outline"
                                className="text-[10px] font-medium bg-blue-50 dark:bg-blue-950/30 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800"
                              >
                                OAuth
                              </Badge>
                            </TooltipTrigger>
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <Badge
                                variant="outline"
                                className="text-[10px] font-medium bg-purple-50 dark:bg-purple-950/30 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-800"
                              >
                                API Key
                              </Badge>
                            </TooltipTrigger>
          ...
          {state.enabled && !isExpanded && (
            <div className="flex items-center justify-between gap-3 mb-3 pt-2 border-t border-border">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <span>
                  {activeSectionCount}/{metadata.sections.length} seções
                </span>
                {hasMissingRequired && (
                  <span className="text-amber-600 dark:text-amber-500 font-medium">
                    • {pluginMissingConfigs.length} campo{pluginMissingConfigs.length > 1 ? "s" : ""} obrigatório
                    {pluginMissingConfigs.length > 1 ? "s" : ""}
                  </span>
                )}
              </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      {pluginMissingConfigs.length === 0 && <Zap className="h-3 w-3" />}
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        >
                          {hasMissing && <AlertCircle className="h-3 w-3 text-amber-600 dark:text-amber-500" />}
                          {!hasMissing && <Zap className="h-3 w-3" />}
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="top" className="max-w-xs p-3">
                            <div className="space-y-2">
                              ...
                              {hasConfigs && (
                                <p className="text-xs text-primary mt-1 font-medium">{t("hasConfigurations")}</p>
                              )}
                            </div>
                          </TooltipContent>
                        </Tooltip>
