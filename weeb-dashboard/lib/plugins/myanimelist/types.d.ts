...
export type AnyMalFavorite = BasicAnimeFavorite[] | BasicMangaFavorite[] | BasicCharacterFavorite[] | BasicPeopleFavorite[];
export type AnyMalFavoriteUnique = BasicAnimeFavorite | BasicMangaFavorite | BasicCharacterFavorite | BasicPeopleFavorite;
export interface MyAnimeListConfig {
    enabled: boolean;
    sections: string[];
    username: string;
