...
export default function DiffTab({ reactSnapshot, svgSnapshot }: DiffTabProps) {
  ...
  const hasDifferences =
    (classDiff?.onlyInReact.length || 0) > 0 ||
    (classDiff?.onlyInSvg.length || 0) > 0 ||
    (varsDiff?.onlyInReact.length || 0) > 0 ||
    (varsDiff?.onlyInSvg.length || 0) > 0 ||
    (varsDiff?.valueDiffs.length || 0) > 0 ||
    (styleDiff?.length || 0) > 0
              ...
              <div>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "4px" }}>
                  ...
                  {classDiff.inBoth.length > 20 && (
                    <span style={{ color: "#8b949e", fontSize: "11px" }}>+{classDiff.inBoth.length - 20} more</span>
                  )}
                </div>
              </div>
            )}
            {!hasDifferences && filter === "different" && (
              <div style={{ color: "#8b949e", textAlign: "center", padding: "16px" }}>No class differences</div>
            )}
          </div>
        </div>
      )}
      ...
      {varsDiff && (
        <div style={{ marginBottom: "20px" }}>
          ...
          >
            ...
            {!hasDifferences && filter === "different" && (
              <div style={{ color: "#8b949e", textAlign: "center", padding: "16px" }}>No variable differences</div>
            )}
          </div>
        </div>
      )}
